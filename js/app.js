(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-people", "swiper-great", "swiper-blog")) {
            new core(".swiper-people", {
    ...
    function app() {
        ...
        function filter(category, items) {
            items.forEach((item => {
                ...
                const isSwoAll = "all" === category.toLowerCase();
                if (isItemFilter && !isSwoAll) item.classList.add("anime"); else {
        ...
        buttons.forEach((button => {
            ...
            box.forEach((box => {
                box.ontransitionend = function() {
                    if (box.classList.contains("anime")) box.classList.add("hides");
                };
            }));
        }));
    }
